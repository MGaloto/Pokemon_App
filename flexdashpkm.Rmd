...
.navbar-brand {
    ...
    background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/International_Pok%C3%A9mon_logo.svg/640px-International_Pok%C3%A9mon_logo.svg.png);
...
renderHighchart({
  ...
  groupvar <- input$group
   ...
   if (input$shiny == 1){
    img_input = paste0("<b>Shiny: {point.name} </b> <img src ='", colnames(txt) , "shiny/{point.pokedex_number}.png' width='100' height='120'>")
  }
  else {
    img_input = paste0("<b>Pokemon: {point.name} </b> <img src ='", colnames(txt) , "{point.pokedex_number}.png' width='100' height='120'>")
  }
