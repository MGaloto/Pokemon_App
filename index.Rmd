...
mean_type_uno = reactive({round(mean(df[,react_xvalue_dos()][df$type1 == react_typevalue_1()], na.rm = T),0)})

vector_type_uno = reactive({
  c(unique(df[,'type_1_color'][df$type1 == react_typevalue_1()])[!is.na(unique(df[,'type_1_color'][df$type1 == react_typevalue_1()]))], 
...
output$chart_type_1 = renderHighchart({
  ...
  highchart() %>%
    ...
    hc_yAxis(
      ...
      minorTickWidth = 0,
      tickAmount = 2,
      min = value_min_max() / 1.15,
      max = value_min_max() * 1.15,
